...
@section('content')
    ...
    <div class="row my-5">
        <div class="col-md-6 mx-auto">
            ...
            <form method="post" action="{{route('admin.post.store')}}" enctype="multipart/form-data" class="border rounded p-5">
                ...
                <div class="row mb-3">
                    ...
                    <input type="text" name="title" id="title"
                           ...
                           placeholder="نام محصول" autocomplete="off" value="{{old('title')}}">
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <input type="text" name="processormodel" id="processormodel"
                           ...
                           placeholder="مدل پردازنده" autocomplete="off" value="{{old('processormodel')}}">
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <input type="text" name="rammemory" id="rammemory"
                           ...
                           placeholder="حافظه رم" autocomplete="off" value="{{old('rammemory')}}">
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <input type="text" name="internalmemorycapacity" id="internalmemorycapacity"
                           ...
                           placeholder="ظرفیت حافظه داخلی" autocomplete="off" value="{{old('internalmemorycapacity')}}">
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <input type="text" name="gpumodel" id="gpumodel"
                           ...
                           placeholder="مدل پردازنده گرافیکی" autocomplete="off" value="{{old('gpumodel')}}">
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <input type="text" name="graphicmemory" id="graphicmemory"
                           ...
                           placeholder="حافظه گرافیکی" autocomplete="off" value="{{old('graphicmemory')}}">
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <input type="text" name="screensize" id="screensize"
                           ...
                           placeholder="اندازه صفحه نمایشگر" autocomplete="off" value="{{old('screensize')}}">
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <input type="text" name="screenaccuracy" id="screenaccuracy"
                           ...
                           placeholder="دقت صفحه نمایش" autocomplete="off" value="{{old('screenaccuracy')}}">
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <input type="text" name="opticaldrive" id="opticaldrive"
                           ...
                           placeholder="درایو نوری" autocomplete="off" value="{{old('opticaldrive')}}">
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <input type="text" name="operatingsystem" id="operatingsystem"
                           ...
                           placeholder="سیستم عامل" autocomplete="off" value="{{old('operatingsystem')}}">
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <input type="text" name="price" id="price"
                           ...
                           placeholder="قیمت" autocomplete="off" value="{{old('price')}}">
                </div>

                <div class="row mb-3">
                    <input type="submit" name="add-product" id="add-product" class="btn btn-sm btn-success mt-5" value="افزودن کالا">
                </div>
            </form>
        </div>
    </div>
